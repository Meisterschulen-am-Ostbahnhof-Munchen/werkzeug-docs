...
Master craftsmen and women must professionally manufacture cable harnesses, crimp gas-tight connectors, repair/assemble circuit boards, and perform diagnostics using oscilloscopes and laboratory power supplies.

---

---

## 🧰 Three categories of tools in master craftsman training

This wiki covers all three tool categories required by the 2025 curriculum framework:
