...
> Soldering is a thermal process for joining materials by creating a metallurgical bond. A liquid phase is formed either by melting a solder (soldering) or by diffusion at the interfaces (diffusion soldering). This creates a surface alloy, but the workpiece is not melted to its core: the liquidus temperature of the base materials is not reached. After the solder solidifies, a metallurgical bond is formed, similar to welding.
...
## Soft Soldering
Soft soldering is a common method for connecting electronic components. Here are the steps for soft soldering:
...
- Place the components in the desired locations on the circuit board.
...
- Allow the solder joint to cool so that the solder hardens.

5. **Cleaning**:

- Remove excess solder and clean the circuit board.
...
1) Getting Started with Soldering - Tutorial for Beginners - Part 2: Hot Air Soldering a Circuit Board. https://www.youtube.com/watch?v=cD-h0lzCGmE.

2) Soldering Explained Simply - Soft Soldering. https://www.youtube.com/watch?v=b0AT86CDySY.

3) Soft Soldering Part 2... Soldering a Vertical Solder Joint. https://www.youtube.com/watch?v=61Zk8QZ6A_Y.

4) Soldering Circuit Boards in 7 Steps - DIY Tutorial - Bonedo. https://www.bonedo.de/artikel/diy-tutorial-platinen-loeten-in-7-schritten/.

5) Instructions for proper soldering – it's that easy - professional guide. https://www.jh-profishop.de/profi-guide/richtig-loeten/.

6) Soldering correctly – tips and tricks for home use - OBI. https://bing.com/search?q=Einf%c3%bchrungsblock+L%c3%b6ten+Weichl%c3%b6ten+L%c3%b6ten+auf+Platinen.

7) Soldering correctly explained step by step | hagebau.de. https://www.hagebau.de/beratung-loeten/.
