...
All of them have in common that the same soldering tips fit,
...
In daily use, you'll need about one tip per day, and these aren't up to the task of handling aggressive solder.

The soldering tips are purely passive components that are attached to a ceramic heating element with a relatively large amount of play.
