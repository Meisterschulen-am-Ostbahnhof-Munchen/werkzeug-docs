...
The power supply has the following information:
...
A magnet leads to the standby mode. Shutdown
...
With some effort: a 6mm² cable could be tinned.

The soldering iron works well with 0.75mm².
